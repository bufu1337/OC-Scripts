...
local function Proxies(name)
    local pr = {
            ...
            extra{home={proxy="b25af6e2-8cd0-48e2-ada7-0f67ba3e7093", tocraft=sides.east, toroute=sides.west}, craft={proxy="21c96f51-ebbf-4d54-a35b-494d366bc9e3", tohome=sides.south, toroute=sides.west}, route={proxy="ab66f881-a610-44f4-b9da-f027a3364e34", home=sides.west, route=sides.east}}
    }
    return pr[name]
end
