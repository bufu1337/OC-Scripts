...
(function (window, undefined) {
    var
        ...
        // Define a local copy of JQX
        JQX = function (selector, context) {
            // The JQX object is actually just the init constructor 'enhanced'
            return new JQX.fn.init(selector, context, rootJQX);
        },
        ...
        // Used by JQX.camelCase as callback to replace()
    ...
    JQX.fn = JQX.prototype = {
        constructor: JQX,
        init: function (selector, context, rootJQX) {
            ...
            if (typeof selector === "string") {
                ...
                if (match && (match[1] || !context)) {
                    ...
                    // HANDLE: $(html) -> $(array)
                    if (match[1]) {
                        context = context instanceof JQX ? context[0] : context;
                        doc = (context && context.nodeType ? context.ownerDocument || context : document);

                        // scripts is true for back-compat
                        selector = JQX.parseHTML(match[1], doc, true);
                        if (rsingleTag.test(match[1]) && JQX.isPlainObject(context)) {
                            this.attr.call(selector, context, true);
                        }

                        return JQX.merge(this, selector);
                        ...
                        if (elem && elem.parentNode) {
                            ...
                            if (elem.id !== match[2]) {
                                return rootJQX.find(selector);
                            }

                            // Otherwise, we inject the element directly into the JQX object
                            this.length = 1;
                            this[0] = elem;
                        }
                    ...
                    return (context || rootJQX).find(selector);
            ...
            } else if (JQX.isFunction(selector)) {
                return rootJQX.ready(selector);
            }
            ...
            return JQX.makeArray(selector, this);
        },

        // Start with an empty selector
        selector: "",

        // The current version of JQX being used
        jqx: "4.5.0",

        // The default length of a JQX object is 0
        length: 0,
        ...
        pushStack: function (elems, name, selector) {
            ...
            // Build a new JQX matched element set
            var ret = JQX.merge(this.constructor(), elems);
        ...
        each: function (callback, args) {
            return JQX.each(this, callback, args);
        },

        ready: function (fn) {
            // Add the callback
            JQX.ready.promise().done(fn);
        ...
        map: function (callback) {
            return this.pushStack(JQX.map(this, function (elem, i) {
        ...
        // Behaves like an Array's method, not like a JQX method.
        push: core_push,
        sort: [].sort,
        splice: [].splice
    };

    // Give the init function the JQX prototype for later instantiation
    JQX.fn.init.prototype = JQX.fn;

    JQX.extend = JQX.fn.extend = function () {
        ...
        if (typeof target !== "object" && !JQX.isFunction(target)) {
            target = {};
        }

        // extend JQX itself if only one argument is passed
        if (length === i) {
            target = this;
            --i;
        }
        ...
        for (; i < length; i++) {
            ...
            if ((options = arguments[i]) != null) {
                ...
                for (name in options) {
                    ...
                    if (deep && copy && (JQX.isPlainObject(copy) || (copyIsArray = JQX.isArray(copy)))) {
                        if (copyIsArray) {
                            copyIsArray = false;
                            clone = src && JQX.isArray(src) ? src : [];

                        } else {
                            clone = src && JQX.isPlainObject(src) ? src : {};
                        }

                        // Never move original objects, clone them
                        target[name] = JQX.extend(deep, clone, copy);
    ...
    JQX.extend({
        ...
        ready: function (wait) {
            ...
            if (wait === true ? --JQX.readyWait : JQX.isReady) {
                return;
            }

            // Make sure body exists, at least, in case IE gets a little overzealous (ticket #5443).
            if (!document.body) {
                return setTimeout(JQX.ready, 1);
            }
            ...
            if (wait !== true && --JQX.readyWait > 0) {
                return;
            }

            // If there are functions bound, to execute
            readyList.resolveWith(document, [JQX]);

            // Trigger any bound ready events
            if (JQX.fn.trigger) {
                JQX(document).trigger("ready").off("ready");
            }
        },
        ...
        isFunction: function (obj) {
            return JQX.type(obj) === "function";
        },

        isArray: Array.isArray || function (obj) {
            return JQX.type(obj) === "array";
        },
        ...
        isPlainObject: function (obj) {
            ...
            if (!obj || JQX.type(obj) !== "object" || obj.nodeType || JQX.isWindow(obj)) {
                return false;
            }
        ...
        parseHTML: function (data, context, scripts) {
            ...
            parsed = JQX.buildFragment([data], context, scripts ? null : []);
            return JQX.merge([],
                (parsed.cacheable ? JQX.clone(parsed.fragment) : parsed.fragment).childNodes);
        },
        ...
        each: function (obj, callback, args) {
            var name,
                i = 0,
                length = obj.length,
                isObj = length === undefined || JQX.isFunction(obj);
        ...
        makeArray: function (arr, results) {
            ...
            if (arr != null) {
                ...
                if (arr.length == null || type === "string" || type === "function" || type === "regexp" || JQX.isWindow(arr)) {
        ...
        map: function (elems, callback, arg) {
            var value, key,
                ...
                isArray = elems instanceof JQX || length !== undefined && typeof length === "number" && ((length > 0 && elems[0] && elems[length - 1]) || length === 0 || JQX.isArray(elems));
        ...
        proxy: function (fn, context) {
            ...
            proxy.guid = fn.guid = fn.guid || JQX.guid++;
        ...
        access: function (elems, fn, key, value, chainable, emptyGet, pass) {
            ...
            if (key && typeof key === "object") {
                for (i in key) {
                    JQX.access(elems, fn, i, key[i], 1, emptyGet, value);
                }
                chainable = 1;
                ...
                exec = pass === undefined && JQX.isFunction(value);
                ...
                if (bulk) {
                    ...
                    if (exec) {
                        ...
                        fn = function (elem, key, value) {
                            return exec.call(JQX(elem), value);
                        };
    ...
    JQX.ready.promise = function (obj) {
        if (!readyList) {

            readyList = JQX.Deferred();
            ...
            if (document.readyState === "complete") {
                ...
                window.addEventListener("load", JQX.ready, false);
                ...
                // A fallback to window.onload, that will always work
                window.attachEvent("onload", JQX.ready);
    ...
    JQX.each("Boolean Number String Function Array Date RegExp Object".split(" "), function (i, name) {
        class2type["[object " + name + "]"] = name.toLowerCase();
    });

    // All JQX objects should point back to these
    rootJQX = JQX(document);
    ...
    function createOptions(options) {
        ...
        JQX.each(options.split(core_rspace), function (_, flag) {
            object[flag] = true;
        });
        return object;
    }
     ...
     *
     */
    JQX.Callbacks = function (options) {
            ...
            self = {
                ...
                add: function () {
                    if (list) {
                        ...
                        (function add(args) {
                            JQX.each(args, function (_, arg) {
                                var type = JQX.type(arg);
                                if (type === "function") {
                ...
                remove: function () {
                    if (list) {
                        JQX.each(arguments, function (_, arg) {
                            var index;
                            while ((index = JQX.inArray(arg, list, index)) > -1) {
                                list.splice(index, 1);
    ...
    JQX.extend({
        ...
        Deferred: function (func) {
            var tuples = [
                    ...
                    ["resolve", "done", JQX.Callbacks("once memory"), "resolved"],
                    ["reject", "fail", JQX.Callbacks("once memory"), "rejected"],
                    ["notify", "progress", JQX.Callbacks("memory")]
            ],
                state = "pending",
                promise = {
                    state: function () {
                    ...
                    then: function ( /* fnDone, fnFail, fnProgress */) {
                        var fns = arguments;
                        return JQX.Deferred(function (newDefer) {
                            JQX.each(tuples, function (i, tuple) {
                                var action = tuple[0],
                                    fn = fns[i];
                                // deferred[ done | fail | progress ] for forwarding actions to newDefer
                                deferred[tuple[1]](JQX.isFunction(fn) ?
                                    function () {
                                        var returned = fn.apply(this, arguments);
                                        if (returned && JQX.isFunction(returned.promise)) {
                                            returned.promise()
                    ...
                    promise: function (obj) {
                        return obj != null ? JQX.extend(obj, promise) : promise;
                    }
                },
                deferred = {};
        ...
        when: function (subordinate /* , ..., subordinateN */) {
            var i = 0,
                ...
                remaining = length !== 1 || (subordinate && JQX.isFunction(subordinate.promise)) ? length : 0,

                // the master Deferred. If resolveValues consist of only a single Deferred, just use that.
                deferred = remaining === 1 ? subordinate : JQX.Deferred(),
            ...
            if (length > 1) {
                ...
                for (; i < length; i++) {
                    if (resolveValues[i] && JQX.isFunction(resolveValues[i].promise)) {
    ...
    JQX.support = (function () {
        ...
        support = {
            ...
            // JQX.support.boxModel DEPRECATED in 1.8 since we don't support Quirks Mode
    ...
    JQX.extend({
        ...
        // Unique for each copy of JQX on the page
        // Non-digits removed to match rinlinejQuery
        expando: "JQX" + (JQX.fn.jqx + Math.random()).replace(/\D/g, ""),
        ...
        hasData: function (elem) {
            elem = elem.nodeType ? JQX.cache[elem[JQX.expando]] : elem[JQX.expando];
            return !!elem && !isEmptyDataObject(elem);
        },

        data: function (elem, name, data, pvt /* Internal Use Only */) {
            if (!JQX.acceptData(elem)) {
                return;
            }

            var thisCache, ret,
                internalKey = JQX.expando,
                ...
                // Only DOM nodes need the global JQX cache; JS object data is
                // attached directly to the object so GC can occur automatically
                cache = isNode ? JQX.cache : elem,
            ...
            if (!id) {
                ...
                if (isNode) {
                    elem[internalKey] = id = JQX.deletedIds.pop() || JQX.guid++;
                } else {
                    id = internalKey;
                }
            }
            ...
            if (!cache[id]) {
                ...
                // Avoids exposing JQX metadata on plain JS objects when the object
                // is serialized using JSON.stringify
                if (!isNode) {
                    cache[id].toJSON = JQX.noop;
                }
            }

            // An object can be passed to JQX.data instead of a key/value pair; this gets
            // shallow copied over onto the existing cache
            if (typeof name === "object" || typeof name === "function") {
                if (pvt) {
                    cache[id] = JQX.extend(cache[id], name);
                } else {
                    cache[id].data = JQX.extend(cache[id].data, name);
                }
            }

            thisCache = cache[id];

            // JQX data() is stored in a separate object inside the object's internal data
            ...
            if (data !== undefined) {
                thisCache[JQX.camelCase(name)] = data;
            }
            ...
            if (getByName) {
                ...
                if (ret == null) {
                    ...
                    ret = thisCache[JQX.camelCase(name)];
                }
            } else {
                ret = thisCache;
            }
        ...
        removeData: function (elem, name, pvt /* Internal Use Only */) {
            ...
            var thisCache, i, l,
                ...
                // See JQX.data for more information
                cache = isNode ? JQX.cache : elem,
                id = isNode ? elem[JQX.expando] : JQX.expando;
            ...
            if (name) {
                ...
                if (thisCache) {
                    ...
                    if (!(pvt ? isEmptyDataObject : JQX.isEmptyObject)(thisCache)) {
                        return;
                    }
                }
            }
            ...
            // Destroy the cache
            if (isNode) {
                JQX.cleanData([elem], true);

                // Use delete when supported for expandos or `cache` is not a window per isWindow (#10080)
            } else if (JQX.support.deleteExpando || cache != cache.window) {
                delete cache[id];
        ...
        _data: function (elem, name, data) {
            return JQX.data(elem, name, data, true);
        },

        // A method for determining if a DOM node can handle the data expando
        acceptData: function (elem) {
            var noData = elem.nodeName && JQX.noData[elem.nodeName.toLowerCase()];
        ...
        data: function (key, value) {
            ...
            if (key === undefined) {
                if (this.length) {
                    ...
                    if (elem.nodeType === 1 && !JQX._data(elem, "parsedAttrs")) {
                        attr = elem.attributes;
                        for (l = attr.length; i < l; i++) {
                            name = attr[i].name;

                            if (!name.indexOf("data-")) {
                                name = JQX.camelCase(name.substring(5));

                                dataAttr(elem, name, data[name]);
                            }
                        }
                        JQX._data(elem, "parsedAttrs", true);
                    }
                }
            ...
            return JQX.access(this, function (value) {
        ...
        if (data === undefined && elem.nodeType === 1) {
            ...
            if (typeof data === "string") {
                try {
                    ...
                    +data + "" === data ? +data :
                    rbrace.test(data) ? JQX.parseJSON(data) :
                        data;
                } catch (e) { }

                // Make sure we set the data so it isn't changed later
                JQX.data(elem, key, data);
    ...
    function isEmptyDataObject(obj) {
        ...
        for (name in obj) {
            ...
            if (name === "data" && JQX.isEmptyObject(obj[name])) {
                continue;
            }
            if (name !== "toJSON") {
                return false;
    ...
    JQX.extend({
        queue: function (elem, type, data) {
            ...
            if (elem) {
                type = (type || "fx") + "queue";
                queue = JQX._data(elem, type);

                // Speed up dequeue by getting out quickly if this is just a lookup
                if (data) {
                    if (!queue || JQX.isArray(data)) {
                        queue = JQX._data(elem, type, JQX.makeArray(data));
                    } else {
                        queue.push(data);
                    }
                }
        ...
        dequeue: function (elem, type) {
            ...
            var queue = JQX.queue(elem, type),
                startLength = queue.length,
                fn = queue.shift(),
                hooks = JQX._queueHooks(elem, type),
                next = function () {
                    JQX.dequeue(elem, type);
                };
        ...
        _queueHooks: function (elem, type) {
            ...
            return JQX._data(elem, key) || JQX._data(elem, key, {
                empty: JQX.Callbacks("once memory").add(function () {
                    JQX.removeData(elem, type + "queue", true);
                    JQX.removeData(elem, key, true);
                })
            });
        }
    });
    ...
    JQX.fn.extend({
        queue: function (type, data) {
            ...
            if (arguments.length < setter) {
                return JQX.queue(this[0], type);
            }

            return data === undefined ?
                this :
                this.each(function () {
                    var queue = JQX.queue(this, type, data);

                    // ensure a hooks for this queue
                    JQX._queueHooks(this, type);

                    if (type === "fx" && queue[0] !== "inprogress") {
                        JQX.dequeue(this, type);
                    }
                });
        },
        ...
        delay: function (time, type) {
            time = JQX.fx ? JQX.fx.speeds[time] || time : time;
            type = type || "fx";
        ...
        promise: function (type, obj) {
            ...
            while (i--) {
                tmp = JQX._data(elements[i], type + "queueHooks");
                if (tmp && tmp.empty) {
                    count++;
    ...
    var nodeHook, boolHook, fixSpecified,
        ...
        getSetAttribute = JQX.support.getSetAttribute;

    JQX.fn.extend({
        attr: function (name, value) {
            return JQX.access(this, JQX.attr, name, value, arguments.length > 1);
        },

        removeAttr: function (name) {
            return this.each(function () {
                JQX.removeAttr(this, name);
            });
        },

        prop: function (name, value) {
            return JQX.access(this, JQX.prop, name, value, arguments.length > 1);
        },

        removeProp: function (name) {
            name = JQX.propFix[name] || name;
            return this.each(function () {
        ...
        addClass: function (value) {
            ...
            if (JQX.isFunction(value)) {
                return this.each(function (j) {
                    JQX(this).addClass(value.call(this, j, this.className));
                });
            }
                ...
                for (i = 0, l = this.length; i < l; i++) {
                    ...
                    if (elem.nodeType === 1) {
                        if (!elem.className && classNames.length === 1) {
                            ...
                            elem.className = JQX.trim(setClass);
                        }
                    }
                }
            }
        ...
        removeClass: function (value) {
            ...
            if (JQX.isFunction(value)) {
                return this.each(function (j) {
                    JQX(this).removeClass(value.call(this, j, this.className));
                });
            }
            if ((value && typeof value === "string") || value === undefined) {
                ...
                for (i = 0, l = this.length; i < l; i++) {
                    ...
                    if (elem.nodeType === 1 && elem.className) {
                        ...
                        elem.className = value ? JQX.trim(className) : "";
                    }
                }
            }
        ...
        toggleClass: function (value, stateVal) {
            ...
            if (JQX.isFunction(value)) {
                return this.each(function (i) {
                    JQX(this).toggleClass(value.call(this, i, this.className, stateVal), stateVal);
                });
            }
            ...
            return this.each(function () {
                if (type === "string") {
                    ...
                    if (this.className) {
                        ...
                        JQX._data(this, "__className__", this.className);
                    }

                    // toggle whole className
                    this.className = this.className || value === false ? "" : JQX._data(this, "__className__") || "";
                }
            });
        },
        ...
        val: function (value) {
            ...
            if (!arguments.length) {
                if (elem) {
                    hooks = JQX.valHooks[elem.type] || JQX.valHooks[elem.nodeName.toLowerCase()];
            ...
            isFunction = JQX.isFunction(value);
            ...
            return this.each(function (i) {
                ...
                if (val == null) {
                    ...
                    val += "";
                } else if (JQX.isArray(val)) {
                    val = JQX.map(val, function (value) {
                        return value == null ? "" : value + "";
                    });
                }

                hooks = JQX.valHooks[this.type] || JQX.valHooks[this.nodeName.toLowerCase()];
    ...
    JQX.extend({
        valHooks: {
            ...
            select: {
                    ...
                    for (; i < max; i++) {
                        ...
                        if ((option.selected || i === index) &&
                            // Don't return options that are disabled or in a disabled optgroup
                                (JQX.support.optDisabled ? !option.disabled : option.getAttribute("disabled") === null) &&
                                (!option.parentNode.disabled || !JQX.nodeName(option.parentNode, "optgroup"))) {

                            // Get the specific value for the option
                            value = JQX(option).val();
                ...
                set: function (elem, value) {
                    var values = JQX.makeArray(value);

                    JQX(elem).find("option").each(function () {
                        this.selected = JQX.inArray(JQX(this).val(), values) >= 0;
                    });
        ...
        attr: function (elem, name, value, pass) {
            ...
            if (pass && JQX.isFunction(JQX.fn[name])) {
                return JQX(elem)[name](value);
            }

            // Fallback to prop when attributes are not supported
            if (typeof elem.getAttribute === "undefined") {
                return JQX.prop(elem, name, value);
            }

            notxml = nType !== 1 || !JQX.isXMLDoc(elem);

            // All attributes are lowercase
            // Grab necessary hook if one is defined
            if (notxml) {
                name = name.toLowerCase();
                hooks = JQX.attrHooks[name] || (rboolean.test(name) ? boolHook : nodeHook);
            }

            if (value !== undefined) {

                if (value === null) {
                    JQX.removeAttr(elem, name);
                    return;
        ...
        removeAttr: function (elem, value) {
            ...
            if (value && elem.nodeType === 1) {
                ...
                for (; i < attrNames.length; i++) {
                    ...
                    if (name) {
                        propName = JQX.propFix[name] || name;
        ...
        attrHooks: {
            type: {
                set: function (elem, value) {
                    ...
                    if (rtype.test(elem.nodeName) && elem.parentNode) {
                        JQX.error("type property can't be changed");
                    } else if (!JQX.support.radioValue && value === "radio" && JQX.nodeName(elem, "input")) {
            ...
            value: {
                get: function (elem, name) {
                    if (nodeHook && JQX.nodeName(elem, "button")) {
    ...
    if (!JQX.support.enctype) {
        JQX.propFix.enctype = "encoding";
    }
    ...
    var rformElems = /^(?:textarea|input|select)$/i,
        ...
        hoverHack = function (events) {
            return JQX.event.special.hover ? events : events.replace(rhoverHack, "mouseenter$1 mouseleave$1");
        };
    ...
    JQX.event = {
        ...
        add: function (elem, types, handler, data, selector) {
            ...
            if (elem.nodeType === 3 || elem.nodeType === 8 || !types || !handler || !(elemData = JQX._data(elem))) {
                return;
            }
            ...
            if (!eventHandle) {
                elemData.handle = eventHandle = function (e) {
                    // Discard the second event of a JQX.event.trigger() and
                    // when an event is called after a page has unloaded
                    return typeof JQX !== "undefined" && (!e || JQX.event.triggered !== e.type) ?
                        JQX.event.dispatch.apply(eventHandle.elem, arguments) :
                        undefined;
                };
            ...
            // JQX(...).bind("mouseover mouseout", fn);
            types = JQX.trim(hoverHack(types)).split(" ");
            for (t = 0; t < types.length; t++) {
                ...
                special = JQX.event.special[type] || {};
                ...
                handleObj = JQX.extend({
                    ...
                    guid: handler.guid,
                    selector: selector,
                    needsContext: selector && JQX.expr.match.needsContext.test(selector),
        ...
        remove: function (elem, types, handler, selector, mappedTypes) {
            ...
            var t, tns, type, origType, namespaces, origCount,
                ...
                elemData = JQX.hasData(elem) && JQX._data(elem);
            ...
            for (t = 0; t < types.length; t++) {
                ...
                if (!type) {
                    for (type in events) {
                        JQX.event.remove(elem, type + types[t], handler, selector, true);
                    }
                    continue;
                }
                ...
                if (eventType.length === 0 && origCount !== eventType.length) {
                    if (!special.teardown || special.teardown.call(elem, namespaces, elemData.handle) === false) {
                        JQX.removeEvent(elem, type, elemData.handle);
                    }
            ...
            if (JQX.isEmptyObject(events)) {
                delete elemData.handle;

                // removeData also checks for emptiness and clears the expando if empty
                // so use it instead of delete
                JQX.removeData(elem, "events", true);
            }
        },
        ...
        trigger: function (event, data, elem, onlyHandlers) {
            ...
            if (rfocusMorph.test(type + JQX.event.triggered)) {
                return;
            }
            ...
            if ((!elem || JQX.event.customEvent[type]) && !JQX.event.global[type]) {
                // No JQX handlers for this event type, and it can't have inline handlers
                return;
            }
            ...
            event = typeof event === "object" ?
                // JQX.Event object
                event[JQX.expando] ? event :
                // Object literal
                new JQX.Event(type, event) :
            ...
            if (!elem) {
                ...
                for (i in cache) {
                    if (cache[i].events && cache[i].events[type]) {
                        JQX.event.trigger(event, data, cache[i].handle.elem, true);
                    }
                }
                return;
            }
            ...
            data = data != null ? JQX.makeArray(data) : [];
            data.unshift(event);
            ...
            if (!onlyHandlers && !special.noBubble && !JQX.isWindow(elem)) {
            ...
            for (i = 0; i < eventPath.length && !event.isPropagationStopped() ; i++) {
                ...
                handle = (JQX._data(cur, "events") || {})[event.type] && JQX._data(cur, "handle");
                if (handle) {
                    handle.apply(cur, data);
                }
                // Note that this is a bare JS function and not a JQX handler
                handle = ontype && cur[ontype];
                if (handle && JQX.acceptData(cur) && handle.apply && handle.apply(cur, data) === false) {
            ...
            if (!onlyHandlers && !event.isDefaultPrevented()) {
                ...
                if ((!special._default || special._default.apply(elem.ownerDocument, data) === false) &&
                    !(type === "click" && JQX.nodeName(elem, "a")) && JQX.acceptData(elem)) {

                    // Call a native DOM method on the target with the same name name as the event.
                    // Can't use an .isFunction() check here because IE6/7 fails that test.
                    // Don't do default actions on window, that's where global variables be (#6170)
                    // IE<9 dies on focus/blur to hidden element (#1486)
                    if (ontype && elem[type] && ((type !== "focus" && type !== "blur") || event.target.offsetWidth !== 0) && !JQX.isWindow(elem)) {
                        ...
                        JQX.event.triggered = type;
                        elem[type]();
                        JQX.event.triggered = undefined;
        ...
        dispatch: function (event) {
            ...
            // Make a writable JQX.Event from the native event object
            event = JQX.event.fix(event || window.event);

            var i, j, cur, ret, selMatch, matched, matches, handleObj, sel, related,
                handlers = ((JQX._data(this, "events") || {})[event.type] || []),
                delegateCount = handlers.delegateCount,
                args = core_slice.call(arguments),
                run_all = !event.exclusive && !event.namespace,
                special = JQX.event.special[event.type] || {},
                handlerQueue = [];

            // Use the fix-ed JQX.Event rather than the (read-only) native event
            args[0] = event;
                        ...
                        for (i = 0; i < delegateCount; i++) {
                            ...
                            if (selMatch[sel] === undefined) {
                                selMatch[sel] = handleObj.needsContext ?
                                    JQX(sel, this).index(cur) >= 0 :
                                    JQX.find(sel, this, null, [cur]).length;
                            }
                            if (selMatch[sel]) {
            ...
            for (i = 0; i < handlerQueue.length && !event.isPropagationStopped() ; i++) {
                ...
                for (j = 0; j < matched.matches.length && !event.isImmediatePropagationStopped() ; j++) {
                    ...
                    if (run_all || (!event.namespace && !handleObj.namespace) || event.namespace_re && event.namespace_re.test(handleObj.namespace)) {
                        ...
                        ret = ((JQX.event.special[handleObj.origType] || {}).handle || handleObj.handler)
        ...
        fix: function (event) {
            ...
            var i, prop,
                originalEvent = event,
                fixHook = JQX.event.fixHooks[event.type] || {},
                copy = fixHook.props ? this.props.concat(fixHook.props) : this.props;

            event = JQX.Event(originalEvent);
        ...
        simulate: function (type, elem, event, bubble) {
            ...
            if (bubble) {
                JQX.event.trigger(e, null, elem);
            } else {
                JQX.event.dispatch.call(elem, e);
            }
    ...
    JQX.event.handle = JQX.event.dispatch;

    JQX.removeEvent = document.removeEventListener ?
    ...
    JQX.Event = function (src, props) {
        // Allow instantiation without the 'new' keyword
        if (!(this instanceof JQX.Event)) {
            return new JQX.Event(src, props);
        }
        ...
        if (props) {
            JQX.extend(this, props);
        }

        // Create a timestamp if incoming event doesn't have one
        this.timeStamp = src && src.timeStamp || JQX.now();

        // Mark it as fixed
        this[JQX.expando] = true;
    };
    ...
    // JQX.Event is based on DOM3 Events as specified by the ECMAScript Language Binding
    ...
    JQX.each({
        ...
        JQX.event.special[orig] = {
            ...
            handle: function (event) {
                ...
                if (!related || (related !== target && !JQX.contains(target, related))) {
    ...
    JQX.fn.extend({
        ...
        on: function (types, selector, data, fn, /*INTERNAL*/ one) {
            ...
            if (one === 1) {
                ...
                fn.guid = origFn.guid || (origFn.guid = JQX.guid++);
            }
            return this.each(function () {
                JQX.event.add(this, types, fn, data, selector);
            });
        },
        ...
        off: function (types, selector, fn) {
            ...
            if (types && types.preventDefault && types.handleObj) {
                // ( event )  dispatched JQX.Event
                handleObj = types.handleObj;
                JQX(types.delegateTarget).off(
            ...
            return this.each(function () {
                JQX.event.remove(this, types, fn, selector);
            });
        },
        ...
        trigger: function (type, data) {
            return this.each(function () {
                JQX.event.trigger(type, data, this);
            });
        },
        triggerHandler: function (type, data) {
            if (this[0]) {
                return JQX.event.trigger(type, data, this[0], true);
            }
        },
        ...
        toggle: function (fn) {
            ...
            var args = arguments,
                guid = fn.guid || JQX.guid++,
                i = 0,
                toggler = function (event) {
                    // Figure out which function to execute
                    var lastToggle = (JQX._data(this, "lastToggle" + fn.guid) || 0) % i;
                    JQX._data(this, "lastToggle" + fn.guid, lastToggle + 1);
    ...
    JQX.each(("blur focus focusin focusout load resize scroll unload click dblclick " +
        "mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave " +
        "change select submit keydown keypress keyup error contextmenu").split(" "), function (i, name) {

            // Handle event binding
            JQX.fn[name] = function (data, fn) {
                if (fn == null) {
                    fn = data;
                    data = null;
                }
            ...
            if (rkeyEvent.test(name)) {
                JQX.event.fixHooks[name] = JQX.event.keyHooks;
            }

            if (rmouseEvent.test(name)) {
                JQX.event.fixHooks[name] = JQX.event.mouseHooks;
            }
        });
    /*!
     * Sizzle CSS Selector Engine
     * Copyright 2012 JQX Foundation and other contributors
    ...
    (function (window, undefined) {
        ...
        Sizzle.attr = JQX.attr;
        JQX.find = Sizzle;
        JQX.expr = Sizzle.selectors;
        JQX.expr[":"] = JQX.expr.pseudos;
        JQX.unique = Sizzle.uniqueSort;
        JQX.text = Sizzle.getText;
        JQX.isXMLDoc = Sizzle.isXML;
        JQX.contains = Sizzle.contains;
    ...
    var runtil = /Until$/,
        ...
        isSimple = /^.[^:#\[\.,]*$/,
        rneedsContext = JQX.expr.match.needsContext,
    ...
    JQX.fn.extend({
        find: function (selector) {
            ...
            if (typeof selector !== "string") {
                return JQX(selector).filter(function () {
                    for (i = 0, l = self.length; i < l; i++) {
                        if (JQX.contains(self[i], this)) {
                            return true;
                        }
                    }
                });
        ...
        has: function (target) {
            var i,
                targets = JQX(target, this),
                len = targets.length;

            return this.filter(function () {
                for (i = 0; i < len; i++) {
                    if (JQX.contains(this, targets[i])) {
                        return true;
                    }
                }
            });
            ...
            return !!selector && (
                typeof selector === "string" ?
                    ...
                    rneedsContext.test(selector) ?
                        JQX(selector, this.context).index(this[0]) >= 0 :
                        JQX.filter(selector, this).length > 0 :
        ...
        closest: function (selectors, context) {
            var cur,
                ...
                pos = rneedsContext.test(selectors) || typeof selectors !== "string" ?
                    JQX(selectors, context || this.context) :
                    0;
            ...
            for (; i < l; i++) {
                ...
                while (cur && cur.ownerDocument && cur !== context && cur.nodeType !== 11) {
                    if (pos ? pos.index(cur) > -1 : JQX.find.matchesSelector(cur, selectors)) {
                        ret.push(cur);
                        break;
                    }
                    cur = cur.parentNode;
            ...
            ret = ret.length > 1 ? JQX.unique(ret) : ret;
        ...
        index: function (elem) {
            ...
            if (typeof elem === "string") {
                return JQX.inArray(this[0], JQX(elem));
            }

            // Locate the position of the desired element
            return JQX.inArray(
                // If it receives a JQX object, the first element is used
                elem.jqx ? elem[0] : elem, this);
        },

        add: function (selector, context) {
            var set = typeof selector === "string" ?
                    JQX(selector, context) :
                    JQX.makeArray(selector && selector.nodeType ? [selector] : selector),
                all = JQX.merge(this.get(), set);
    ...
    JQX.each({
        ...
        parents: function (elem) {
            return JQX.dir(elem, "parentNode");
        },
        parentsUntil: function (elem, i, until) {
            return JQX.dir(elem, "parentNode", until);
        },
        next: function (elem) {
        ...
        nextAll: function (elem) {
            return JQX.dir(elem, "nextSibling");
        },
        prevAll: function (elem) {
            return JQX.dir(elem, "previousSibling");
        },
        nextUntil: function (elem, i, until) {
            return JQX.dir(elem, "nextSibling", until);
        },
        prevUntil: function (elem, i, until) {
            return JQX.dir(elem, "previousSibling", until);
        },
        siblings: function (elem) {
            return JQX.sibling((elem.parentNode || {}).firstChild, elem);
        },
        children: function (elem) {
            return JQX.sibling(elem.firstChild);
        },
        contents: function (elem) {
            return JQX.nodeName(elem, "iframe") ?
                elem.contentDocument || elem.contentWindow.document :
                JQX.merge([], elem.childNodes);
        }
    }, function (name, fn) {
        JQX.fn[name] = function (until, selector) {
            var ret = JQX.map(this, fn, until);
            ...
            if (selector && typeof selector === "string") {
                ret = JQX.filter(selector, ret);
            }

            ret = this.length > 1 && !guaranteedUnique[name] ? JQX.unique(ret) : ret;
    ...
    JQX.extend({
        filter: function (expr, elems, not) {
            ...
            return elems.length === 1 ?
                JQX.find.matchesSelector(elems[0], expr) ? [elems[0]] : [] :
                JQX.find.matches(expr, elems);
        },
        ...
        dir: function (elem, dir, until) {
            ...
            while (cur && cur.nodeType !== 9 && (until === undefined || cur.nodeType !== 1 || !JQX(cur).is(until))) {
                if (cur.nodeType === 1) {
                    matched.push(cur);
                }
                cur = cur[dir];
    ...
    function winnow(elements, qualifier, keep) {
        ...
        if (JQX.isFunction(qualifier)) {
            return JQX.grep(elements, function (elem, i) {
            ...
            var filtered = JQX.grep(elements, function (elem) {
                return elem.nodeType === 1;
            });

            if (isSimple.test(qualifier)) {
                return JQX.filter(qualifier, filtered, !keep);
            } else {
                qualifier = JQX.filter(qualifier, filtered);
            }
        }

        return JQX.grep(elements, function (elem, i) {
            return (JQX.inArray(elem, qualifier) >= 0) === keep;
        });
    }
    ...
    JQX.fn.extend({
        ...
        wrapAll: function (html) {
            if (JQX.isFunction(html)) {
                return this.each(function (i) {
                    JQX(this).wrapAll(html.call(this, i));
                });
            }

            if (this[0]) {
                // The elements to wrap the target around
                var wrap = JQX(html, this[0].ownerDocument).eq(0).clone(true);
        ...
        wrapInner: function (html) {
            if (JQX.isFunction(html)) {
                return this.each(function (i) {
                    JQX(this).wrapInner(html.call(this, i));
                });
            }
        ...
        wrap: function (html) {
            var isFunction = JQX.isFunction(html);

            return this.each(function (i) {
                JQX(this).wrapAll(isFunction ? html.call(this, i) : html);
            });
        },

        unwrap: function () {
            return this.parent().each(function () {
                if (!JQX.nodeName(this, "body")) {
                    JQX(this).replaceWith(this.childNodes);
                }
            }).end();
        },
        ...
        before: function () {
            ...
            if (arguments.length) {
                var set = JQX.clean(arguments);
                return this.pushStack(JQX.merge(set, this), "before", this.selector);
            }
        },
        ...
        after: function () {
            ...
            if (arguments.length) {
                var set = JQX.clean(arguments);
                return this.pushStack(JQX.merge(this, set), "after", this.selector);
            }
        },
        ...
        remove: function (selector, keepData) {
            ...
            for (; (elem = this[i]) != null; i++) {
                if (!selector || JQX.filter(selector, [elem]).length) {
                    if (!keepData && elem.nodeType === 1) {
                        JQX.cleanData(elem.getElementsByTagName("*"));
                        JQX.cleanData([elem]);
                    }
        ...
        clone: function (dataAndEvents, deepDataAndEvents) {
            ...
            return this.map(function () {
                return JQX.clone(this, dataAndEvents, deepDataAndEvents);
            });
        },
        ...
        html: function (value) {
            return JQX.access(this, function (value) {
                ...
                if (typeof value === "string" && !rnoInnerhtml.test(value) &&
                    (JQX.support.htmlSerialize || !rnoshimcache.test(value)) &&
                    (JQX.support.leadingWhitespace || !rleadingWhitespace.test(value)) &&
        ...
        replaceWith: function (value) {
            if (!isDisconnected(this[0])) {
                ...
                if (JQX.isFunction(value)) {
                    return this.each(function (i) {
                        var self = JQX(this), old = self.html();
                        self.replaceWith(value.call(this, i, old));
                    });
                }

                if (typeof value !== "string") {
                    value = JQX(value).detach();
                }
                ...
                return this.each(function () {
                    ...
                    if (next) {
                        JQX(next).before(value);
                    } else {
                        JQX(parent).append(value);
                    }
                });
            }

            return this.length ?
                this.pushStack(JQX(JQX.isFunction(value) ? value() : value), "replaceWith", value) :
                this;
        },
        ...
        domManip: function (args, table, callback) {
            ...
            if (!JQX.support.checkClone && l > 1 && typeof value === "string" && rchecked.test(value)) {
                return this.each(function () {
                    JQX(this).domManip(args, table, callback);
                });
            }
            ...
            if (this[0]) {
                results = JQX.buildFragment(args, this, scripts);
                ...
                if (first) {
                    table = table && JQX.nodeName(first, "tr");
                    ...
                    for (iNoClone = results.cacheable || l - 1; i < l; i++) {
                        callback.call(
                            table && JQX.nodeName(this[i], "table") ?
                                findOrAppend(this[i], "tbody") :
                                this[i],
                            i === iNoClone ?
                            fragment :
                                JQX.clone(fragment, true, true)
                        );
                    }
                }
                ...
                if (scripts.length) {
                    JQX.each(scripts, function (i, elem) {
                        if (elem.src) {
                            if (JQX.ajax) {
                                JQX.ajax({
                                    url: elem.src,
                            ...
                            JQX.globalEval((elem.text || elem.textContent || elem.innerHTML || "").replace(rcleanScript, ""));
                        }
    ...
    function cloneCopyEvent(src, dest) {
        ...
        if (dest.nodeType !== 1 || !JQX.hasData(src)) {
            return;
        }

        var type, i, l,
            oldData = JQX._data(src),
            curData = JQX._data(dest, oldData),
        ...
        if (events) {
            ...
            for (type in events) {
                for (i = 0, l = events[type].length; i < l; i++) {
                    JQX.event.add(dest, type, events[type][i]);
                }
            }
        }
        ...
        if (curData.data) {
            curData.data = JQX.extend({}, curData.data);
        }
    }
    ...
    function cloneFixAttributes(src, dest) {
        ...
        if (nodeName === "object") {
            ...
            if (JQX.support.html5Clone && (src.innerHTML && !JQX.trim(dest.innerHTML))) {
        ...
        // gets copied too
        dest.removeAttribute(JQX.expando);
    }

    JQX.buildFragment = function (args, context, scripts) {
        var fragment, cacheable, cachehit,
            first = args[0];

        // Set context from what may come in as undefined or a JQX collection or a node
        ...
        if (args.length === 1 && typeof first === "string" && first.length < 512 && context === document &&
            ...
            (JQX.support.checkClone || !rchecked.test(first)) &&
            (JQX.support.html5Clone || !rnoshimcache.test(first))) {

            // Mark cacheable and look for a hit
            cacheable = true;
            fragment = JQX.fragments[first];
            cachehit = fragment !== undefined;
        }

        if (!fragment) {
            fragment = context.createDocumentFragment();
            JQX.clean(args, context, fragment, scripts);

            // Update the cache, but only store false
            // unless this is a second parsing of the same content
            if (cacheable) {
                JQX.fragments[first] = cachehit && fragment;
            }
        }
    ...
    JQX.extend({
        clone: function (elem, dataAndEvents, deepDataAndEvents) {
            ...
            if (JQX.support.html5Clone || JQX.isXMLDoc(elem) || !rnoshimcache.test("<" + elem.nodeName + ">")) {
            ...
            if ((!JQX.support.noCloneEvent || !JQX.support.noCloneChecked) &&
                    (elem.nodeType === 1 || elem.nodeType === 11) && !JQX.isXMLDoc(elem)) {
        ...
        clean: function (elems, context, fragment, scripts) {
                    ...
                    if (!rhtml.test(elem)) {
                        ...
                        if (!JQX.support.tbody) {
                            ...
                            for (j = tbody.length - 1; j >= 0 ; --j) {
                                if (JQX.nodeName(tbody[j], "tbody") && !tbody[j].childNodes.length) {
                        ...
                        if (!JQX.support.leadingWhitespace && rleadingWhitespace.test(elem)) {
            ...
            if (!JQX.support.appendChecked) {
                for (i = 0; (elem = ret[i]) != null; i++) {
                    if (JQX.nodeName(elem, "input")) {
                        fixDefaultChecked(elem);
                    } else if (typeof elem.getElementsByTagName !== "undefined") {
                        JQX.grep(elem.getElementsByTagName("input"), fixDefaultChecked);
                    }
                }
            }
            ...
            if (fragment) {
                ...
                for (i = 0; (elem = ret[i]) != null; i++) {
                    ...
                    if (!(JQX.nodeName(elem, "script") && handleScript(elem))) {
                        // Append to fragment and handle embedded scripts
                        fragment.appendChild(elem);
                        if (typeof elem.getElementsByTagName !== "undefined") {
                            // handleScript alters the DOM, so use JQX.merge to ensure snapshot iteration
                            jsTags = JQX.grep(JQX.merge([], elem.getElementsByTagName("script")), handleScript);
        ...
        cleanData: function (elems, /* internal */ acceptData) {
            var data, id, elem, type,
                ...
                internalKey = JQX.expando,
                cache = JQX.cache,
                deleteExpando = JQX.support.deleteExpando,
                special = JQX.event.special;

            for (; (elem = elems[i]) != null; i++) {

                if (acceptData || JQX.acceptData(elem)) {
                    ...
                    if (data) {
                        if (data.events) {
                            for (type in data.events) {
                                if (special[type]) {
                                    JQX.event.remove(elem, type);

                                    // This is a shortcut to avoid JQX.event.remove's overhead
                                } else {
                                    JQX.removeEvent(elem, type, data.handle);
                                }
                            }
                        }

                        // Remove cache only if it was not already removed by JQX.event.remove
                        if (cache[id]) {
    ...
    (function () {
        ...
        // Use of JQX.browser is frowned upon.
        // More details: http://api.jqx.com/JQX.browser
        // JQX.uaMatch maintained for back-compat
        JQX.uaMatch = function (ua) {
            ua = ua.toLowerCase();
        ...
        matched = JQX.uaMatch(navigator.userAgent);
        browser = {};
        ...
        JQX.sub = function () {
            ...
            JQX.extend(true, jQuerySub, this);
            jQuerySub.superclass = this;
            jQuerySub.fn = jQuerySub.prototype = this();
            jQuerySub.fn.constructor = jQuerySub;
            jQuerySub.sub = this.sub;
            jQuerySub.fn.init = function init(selector, context) {
                if (context && context instanceof JQX && !(context instanceof jQuerySub)) {
                    context = jQuerySub(context);
                }

                return JQX.fn.init.call(this, selector, context, rootJQXSub);
            };
            jQuerySub.fn.init.prototype = jQuerySub.fn;
            var rootJQXSub = jQuerySub(document);
            return jQuerySub;
        };
    ...
    function isHidden(elem, el) {
        elem = el || elem;
        return JQX.css(elem, "display") === "none" || !JQX.contains(elem.ownerDocument, elem);
    }
    ...
    function showHide(elements, show) {
        ...
        for (; index < length; index++) {
            ...
            values[index] = JQX._data(elem, "olddisplay");
            if (show) {
                ...
                if (elem.style.display === "" && isHidden(elem)) {
                    values[index] = JQX._data(elem, "olddisplay", css_defaultDisplay(elem.nodeName));
                }
            } else {
                display = curCSS(elem, "display");

                if (!values[index] && display !== "none") {
                    JQX._data(elem, "olddisplay", display);
                }
            }
        }
    ...
    JQX.fn.extend({
        css: function (name, value) {
            return JQX.access(this, function (elem, name, value) {
                return value !== undefined ?
                    JQX.style(elem, name, value) :
                    JQX.css(elem, name);
        ...
        toggle: function (state, fn2) {
            ...
            if (JQX.isFunction(state) && JQX.isFunction(fn2)) {
    ...
    JQX.extend({
        ...
        cssProps: {
            ...
            "float": JQX.support.cssFloat ? "cssFloat" : "styleFloat"
        },
        ...
        style: function (elem, name, value, extra) {
            ...
            var ret, type, hooks,
                origName = JQX.camelCase(name),
                style = elem.style;

            name = JQX.cssProps[origName] || (JQX.cssProps[origName] = vendorPropName(style, origName));

            // gets hook for the prefixed version
            // followed by the unprefixed version
            hooks = JQX.cssHooks[name] || JQX.cssHooks[origName];
            ...
            if (value !== undefined) {
                ...
                if (type === "string" && (ret = rrelNum.exec(value))) {
                    value = (ret[1] + 1) * ret[2] + parseFloat(JQX.css(elem, name));
                    // Fixes bug #9237
                    type = "number";
                }
                ...
                if (type === "number" && !JQX.cssNumber[origName]) {
                    value += "px";
                }
        ...
        css: function (elem, name, numeric, extra) {
            ...
            // Make sure that we're working with the right name
            name = JQX.cssProps[origName] || (JQX.cssProps[origName] = vendorPropName(elem.style, origName));
            ...
            if (numeric || extra !== undefined) {
                num = parseFloat(val);
                return numeric || JQX.isNumeric(num) ? num || 0 : val;
            }
            return val;
        },
    ...
    if (window.getComputedStyle) {
        curCSS = function (elem, name) {
            ...
            if (computed) {
                ...
                if (ret === "" && !JQX.contains(elem.ownerDocument, elem)) {
                    ret = JQX.style(elem, name);
                }
    ...
    function augmentWidthOrHeight(elem, name, extra, isBorderBox) {
        ...
        for (; i < 4; i += 2) {
            ...
            if (extra === "margin") {
                // we use JQX.css instead of curCSS here
                // because of the reliableMarginRight CSS hook!
                val += JQX.css(elem, extra + cssExpand[i], true);
            }
    ...
    function getWidthOrHeight(elem, name, extra) {
        ...
        var val = name === "width" ? elem.offsetWidth : elem.offsetHeight,
            ...
            isBorderBox = JQX.support.boxSizing && JQX.css(elem, "boxSizing") === "border-box";
        ...
        if (val <= 0 || val == null) {
            ...
            valueIsBorderBox = isBorderBox && (JQX.support.boxSizingReliable || val === elem.style[name]);
    ...
    function css_defaultDisplay(nodeName) {
        ...
        var elem = JQX("<" + nodeName + ">").appendTo(document.body),
        ...
        if (display === "none" || display === "") {
            ...
            iframe = document.body.appendChild(
                iframe || JQX.extend(document.createElement("iframe"), {
                    frameBorder: 0,
                    width: 0,
                    height: 0
                })
    ...
    JQX.each(["height", "width"], function (i, name) {
        JQX.cssHooks[name] = {
            get: function (elem, computed, extra) {
                if (computed) {
                    ...
                    if (elem.offsetWidth === 0 && rdisplayswap.test(curCSS(elem, "display"))) {
                        return JQX.swap(elem, cssShow, function () {
            ...
            set: function (elem, value, extra) {
                return setPositiveNumber(elem, value, extra ?
                    augmentWidthOrHeight(
                        ...
                        name,
                        extra,
                        JQX.support.boxSizing && JQX.css(elem, "boxSizing") === "border-box"
                    ) : 0
                );
            }
        };
    ...
    if (!JQX.support.opacity) {
        JQX.cssHooks.opacity = {
            get: function (elem, computed) {
            ...
            set: function (elem, value) {
                var style = elem.style,
                    ...
                    opacity = JQX.isNumeric(value) ? "alpha(opacity=" + value * 100 + ")" : "",
                ...
                if (value >= 1 && JQX.trim(filter.replace(ralpha, "")) === "" &&
    ...
    JQX(function () {
        if (!JQX.support.reliableMarginRight) {
            JQX.cssHooks.marginRight = {
                get: function (elem, computed) {
                    // WebKit Bug 13343 - getComputedStyle returns wrong value for margin-right
                    // Work around by temporarily setting element display to inline-block
                    return JQX.swap(elem, { "display": "inline-block" }, function () {
                        if (computed) {
        ...
        if (!JQX.support.pixelPosition && JQX.fn.position) {
            JQX.each(["top", "left"], function (i, prop) {
                JQX.cssHooks[prop] = {
                    get: function (elem, computed) {
                        if (computed) {
                            var ret = curCSS(elem, prop);
                            // if curCSS returns percentage, fallback to offset
                            return rnumnonpx.test(ret) ? JQX(elem).position()[prop] + "px" : ret;
                        }
                    }
                };
            });
    ...
    if (JQX.expr && JQX.expr.filters) {
        JQX.expr.filters.hidden = function (elem) {
            return (elem.offsetWidth === 0 && elem.offsetHeight === 0) || (!JQX.support.reliableHiddenOffsets && ((elem.style && elem.style.display) || curCSS(elem, "display")) === "none");
        };

        JQX.expr.filters.visible = function (elem) {
            return !JQX.expr.filters.hidden(elem);
        };
    }
    ...
    JQX.each({
        ...
        if (!rmargin.test(prefix)) {
            JQX.cssHooks[prefix + suffix].set = setPositiveNumber;
        }
    });
    var r20 = /%20/g,
        rbracket = /\[\]$/,
    ...
    JQX.fn.extend({
        serialize: function () {
            return JQX.param(this.serializeArray());
        },
        serializeArray: function () {
            return this.map(function () {
                return this.elements ? JQX.makeArray(this.elements) : this;
            })
            .filter(function () {
            ...
            .map(function (i, elem) {
                var val = JQX(this).val();

                return val == null ?
                    null :
                    JQX.isArray(val) ?
                        JQX.map(val, function (val, i) {
    ...
    JQX.param = function (a, traditional) {
        var prefix,
            s = [],
            add = function (key, value) {
                // If value is a function, invoke it and return its value
                value = JQX.isFunction(value) ? value() : (value == null ? "" : value);
                s[s.length] = encodeURIComponent(key) + "=" + encodeURIComponent(value);
            };

        // Set traditional to true for JQX <= 1.3.2 behavior.
        if (traditional === undefined) {
            traditional = JQX.ajaxSettings && JQX.ajaxSettings.traditional;
        }

        // If an array was passed in, assume that it is an array of form elements.
        if (JQX.isArray(a) || (a.jqx && !JQX.isPlainObject(a))) {
    ...
    function buildParams(prefix, obj, traditional, add) {
        ...
        } else if (!traditional && JQX.type(obj) === "object") {
    ...
    if (JQX.support.ajax) {
        ...
        JQX.ajaxTransport(function (s) {
            // Cross domain only allowed if supported through XMLHttpRequest
            if (!s.crossDomain || JQX.support.cors) {
                ...
                return {
                    send: function (headers, complete) {
                        ...
                        // handled in JQX.ajax (so no try/catch here)
                        ...
                        callback = function (_, isAbort) {
                            ...
                            try {
                                ...
                                if (callback && (isAbort || xhr.readyState === 4)) {
                                    ...
                                    if (handle) {
                                        xhr.onreadystatechange = JQX.noop;
                                        if (xhrOnUnloadAbort) {
                        ...
                        if (!s.async) {
                            ...
                            if (xhrOnUnloadAbort) {
                                ...
                                if (!xhrCallbacks) {
                                    xhrCallbacks = {};
                                    JQX(window).unload(xhrOnUnloadAbort);
                                }
        ...
        tweeners = {
            "*": [function (prop, value) {
                ...
                if (parts) {
                    ...
                    unit = parts[3] || (JQX.cssNumber[prop] ? "" : "px");
                    ...
                    if (unit !== "px" && start) {
                        ...
                        start = JQX.css(tween.elem, prop, true) || end || 1;
                        ...
                        do {
                            ...
                            // Adjust and apply
                            start = start / scale;
                            JQX.style(tween.elem, prop, start + unit);
    ...
    function createFxNow() {
        ...
        return (fxNow = JQX.now());
    }

    function createTweens(animation, props) {
        JQX.each(props, function (prop, value) {
    ...
    function Animation(elem, properties, options) {
        var result,
            ...
            deferred = JQX.Deferred().always(function () {
            ...
            animation = deferred.promise({
                elem: elem,
                props: JQX.extend({}, properties),
                opts: JQX.extend(true, { specialEasing: {} }, options),
                ...
                createTween: function (prop, end, easing) {
                    var tween = JQX.Tween(elem, animation.opts, prop, end,
        ...
        if (JQX.isFunction(animation.opts.start)) {
    ...
    function propFilter(props, specialEasing) {
        ...
        for (index in props) {
            name = JQX.camelCase(index);
            easing = specialEasing[name];
            value = props[index];
            if (JQX.isArray(value)) {
                easing = value[1];
    ...
    JQX.Animation = JQX.extend(Animation, {

        tweener: function (props, callback) {
            if (JQX.isFunction(props)) {
                callback = props;
                props = ["*"];
            } else {
                props = props.split(" ");
    ...
    function defaultPrefilter(elem, props, opts) {
        ...
        if (elem.nodeType === 1 && ("height" in props || "width" in props)) {
            ...
            if (JQX.css(elem, "display") === "inline" &&
                    JQX.css(elem, "float") === "none") {

                // inline-level elements accept inline-block;
                // block-level elements need to be inline with layout
                if (!JQX.support.inlineBlockNeedsLayout || css_defaultDisplay(elem.nodeName) === "inline") {
        ...
        if (opts.overflow) {
            ...
            if (!JQX.support.shrinkWrapBlocks) {
                anim.done(function () {
        ...
        if (length) {
            dataShow = JQX._data(elem, "fxshow") || JQX._data(elem, "fxshow", {});
            ...
            anim.done(function () {
                var prop;
                JQX.removeData(elem, "fxshow", true);
                for (prop in orig) {
                    JQX.style(elem, prop, orig[prop]);
                }
            });
            for (index = 0 ; index < length ; index++) {
                prop = handled[index];
                tween = anim.createTween(prop, hidden ? dataShow[prop] : 0);
                orig[prop] = dataShow[prop] || JQX.style(elem, prop);
    ...
    Tween.prototype = {
        ...
        init: function (elem, options, prop, end, easing, unit) {
            ...
            this.end = end;
            this.unit = unit || (JQX.cssNumber[prop] ? "" : "px");
        },
        cur: function () {
        ...
        run: function (percent) {
            ...
            if (this.options.duration) {
                this.pos = eased = JQX.easing[this.easing](
    ...
    Tween.propHooks = {
        _default: {
            get: function (tween) {
                ...
                result = JQX.css(tween.elem, tween.prop, false, "");
            ...
            set: function (tween) {
                ...
                if (JQX.fx.step[tween.prop]) {
                    JQX.fx.step[tween.prop](tween);
                } else if (tween.elem.style && (tween.elem.style[JQX.cssProps[tween.prop]] != null || JQX.cssHooks[tween.prop])) {
                    JQX.style(tween.elem, tween.prop, tween.now + tween.unit);
                } else {
    ...
    JQX.each(["toggle", "show", "hide"], function (i, name) {
        var cssFn = JQX.fn[name];
        JQX.fn[name] = function (speed, easing, callback) {
            return speed == null || typeof speed === "boolean" ||
                // special check for .toggle( handler, handler, ... )
                (!i && JQX.isFunction(speed) && JQX.isFunction(easing)) ?
    ...
    JQX.fn.extend({
        ...
        animate: function (prop, speed, easing, callback) {
            var empty = JQX.isEmptyObject(prop),
                optall = JQX.speed(speed, easing, callback),
                doAnimation = function () {
                    // Operate on a copy of prop so per-property easing won't be lost
                    var anim = Animation(this, JQX.extend({}, prop), optall);
    ...
    JQX.speed = function (speed, easing, fn) {
        var opt = speed && typeof speed === "object" ? JQX.extend({}, speed) : {
            complete: fn || !fn && easing ||
                JQX.isFunction(speed) && speed,
            duration: speed,
            easing: fn && easing || easing && !JQX.isFunction(easing) && easing
        };

        opt.duration = JQX.fx.off ? 0 : typeof opt.duration === "number" ? opt.duration :
            opt.duration in JQX.fx.speeds ? JQX.fx.speeds[opt.duration] : JQX.fx.speeds._default;
        ...
        opt.complete = function () {
            if (JQX.isFunction(opt.old)) {
                opt.old.call(this);
            }

            if (opt.queue) {
                JQX.dequeue(this, opt.queue);
            }
        };
    ...
    JQX.timers = [];
    JQX.fx = Tween.prototype.init;
    JQX.fx.tick = function () {
        var timer,
            timers = JQX.timers,
            i = 0;
    ...
    JQX.fx.timer = function (timer) {
        if (timer() && JQX.timers.push(timer) && !timerId) {
            timerId = setInterval(JQX.fx.tick, JQX.fx.interval);
        }
    };

    JQX.fx.interval = 13;

    JQX.fx.stop = function () {
    ...
    if (JQX.expr && JQX.expr.filters) {
        JQX.expr.filters.animated = function (elem) {
            return JQX.grep(JQX.timers, function (fn) {
                return elem === fn.elem;
            }).length;
        };
    }
    ...
    JQX.fn.offset = function (options) {
        if (arguments.length) {
            return options === undefined ?
                this :
                this.each(function (i) {
                    JQX.offset.setOffset(this, options, i);
                });
        }
        ...
        if ((body = doc.body) === elem) {
            return JQX.offset.bodyOffset(elem);
        }

        docElem = doc.documentElement;

        // Make sure it's not a disconnected DOM node
        if (!JQX.contains(docElem, elem)) {
            return box;
        }
    ...
    JQX.offset = {
        ...
        bodyOffset: function (body) {
            ...
            if (JQX.support.doesNotIncludeMarginInBodyOffset) {
                top += parseFloat(JQX.css(body, "marginTop")) || 0;
                left += parseFloat(JQX.css(body, "marginLeft")) || 0;
            }
        ...
        setOffset: function (elem, options, i) {
            var position = JQX.css(elem, "position");
            ...
            var curElem = JQX(elem),
                curOffset = curElem.offset(),
                curCSSTop = JQX.css(elem, "top"),
                curCSSLeft = JQX.css(elem, "left"),
                calculatePosition = (position === "absolute" || position === "fixed") && JQX.inArray("auto", [curCSSTop, curCSSLeft]) > -1,
    ...
    JQX.fn.extend({
        ...
        position: function () {
            ...
            offset.top -= parseFloat(JQX.css(elem, "marginTop")) || 0;
            offset.left -= parseFloat(JQX.css(elem, "marginLeft")) || 0;

            // Add offsetParent borders
            parentOffset.top += parseFloat(JQX.css(offsetParent[0], "borderTopWidth")) || 0;
            parentOffset.left += parseFloat(JQX.css(offsetParent[0], "borderLeftWidth")) || 0;
        ...
        offsetParent: function () {
            return this.map(function () {
                ...
                while (offsetParent && (!rroot.test(offsetParent.nodeName) && JQX.css(offsetParent, "position") === "static")) {
    ...
    JQX.each({ scrollLeft: "pageXOffset", scrollTop: "pageYOffset" }, function (method, prop) {
        var top = /Y/.test(prop);

        JQX.fn[method] = function (val) {
            return JQX.access(this, function (elem, method, val) {
                ...
                if (win) {
                    win.scrollTo(
                        !top ? val : JQX(win).scrollLeft(),
                        top ? val : JQX(win).scrollTop()
                    );
    ...
    JQX.each({ Height: "height", Width: "width" }, function (name, type) {
        JQX.each({ padding: "inner" + name, content: type, "": "outer" + name }, function (defaultExtra, funcName) {
            // margin is only for outerHeight, outerWidth
            JQX.fn[funcName] = function (margin, value) {
                var chainable = arguments.length && (defaultExtra || typeof margin !== "boolean"),
                    extra = defaultExtra || (margin === true || value === true ? "margin" : "border");

                return JQX.access(this, function (elem, type, value) {
                    var doc;

                    if (JQX.isWindow(elem)) {
                    ...
                    return value === undefined ?
                        ...
                        JQX.css(elem, type, value, extra) :

                        // Set width or height on the element
                        JQX.style(elem, type, value, extra);
                }, type, chainable ? margin : undefined, chainable, null);
            };
        });
    });
    // Expose JQX to the global object
    window.JQX = window.jqxHelper = JQX;

    // Expose JQX as an AMD module, but only for AMD loaders that
    // understand the issues with loading multiple versions of JQX
    // in a page that all might call define(). The loader will indicate
    // they have special allowances for multiple JQX versions by
    // specifying define.amd.JQX = true. Register as a named module,
    // since JQX can be concatenated with other files that may use define,
    // but not use a proper concatenation script that understands anonymous
    // AMD modules. A named AMD is safest and most robust way to register.
    // Lowercase jqx is used because AMD module names are derived from
    // file names, and JQX is normally delivered in a lowercase file name.
    // Do this after creating the global so that if an AMD module wants to call
    // noConflict to hide this version of JQX, it will work.
    if (typeof define === "function" && define.amd && define.amd.JQX) {
        define("jqx", [], function () { return JQX; });
    }
...
(function (window) {
    ...
    if (!window.$) {
        window.$ = window.minQuery = window.JQX;
    }
})(window);
// End of jqxHelper
