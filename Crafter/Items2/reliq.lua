return {
 ...
 xreliquary_jj_magazine={craftCount=5,maxCount=8,recipe={minecraft_jj_glass={need=1},minecraft_jj_iron_ingot={need=5},minecraft_jj_stone={need=2},xreliquary_jj_bullet={need=8},xreliquary_jj_magazine={need=1}}},
